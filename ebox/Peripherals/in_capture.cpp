...
void IN_CAPTURE::init_info(GPIO *capture_pin)
{
	if(this->capture_pin->port == GPIOA)
	{
		...
		{
			case GPIO_Pin_0:
				TIMx = TIM2;ch = TIM_Channel_1;//irq = TIM2_IRQn;
				break;
			case GPIO_Pin_1:
				TIMx = TIM2;ch = TIM_Channel_2;//irq = TIM2_IRQn;
				break;
			case GPIO_Pin_2:
				TIMx = TIM2;ch = TIM_Channel_3;//irq = TIM2_IRQn;
				break;
			case GPIO_Pin_3:
				TIMx = TIM2;ch = TIM_Channel_4;//irq = TIM2_IRQn;
				break;
			
			case GPIO_Pin_6:
				TIMx = TIM3;ch = TIM_Channel_1;//irq = TIM3_IRQn;
				break;
			case GPIO_Pin_7:
				TIMx = TIM3;ch = TIM_Channel_2;//irq = TIM3_IRQn;
				break;
//            case GPIO_Pin_10:
...
//				break;
	...
	if(this->capture_pin->port == GPIOB)
	{
		switch(this->capture_pin->pin)
		{
			...
			case GPIO_Pin_6:
				TIMx = TIM4;ch = TIM_Channel_1;//irq = TIM4_IRQn;
				break;
			case GPIO_Pin_7:
				TIMx = TIM4;ch = TIM_Channel_2;//irq = TIM4_IRQn;
				break;
			case GPIO_Pin_8:
				TIMx = TIM4;ch = TIM_Channel_3;//irq = TIM4_IRQn;
				break;
			case GPIO_Pin_9:
				TIMx = TIM4;ch = TIM_Channel_4;//irq = TIM4_IRQn;
				break;
		}
	}
