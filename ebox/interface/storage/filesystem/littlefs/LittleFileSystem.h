 ...
 */
class LittleFileSystem : public ebox::FileSystem {
public:
     ...
     */
    virtual int mount(ebox::BlockDevice *bd);
     ...
     *  @return         0 on success, negative error code on failure
     */
    virtual int reformat(ebox::BlockDevice *bd);
...
protected:
     ...
     *  @return         0 on success, negative error code on failure.
     */
    virtual int file_open(ebox::fs_file_t *file, const char *path, int flags);
     ...
     *  return          0 on success, negative error code on failure
     */
    virtual int file_close(ebox::fs_file_t file);
     ...
     */
    virtual ssize_t file_read(ebox::fs_file_t file, void *buffer, size_t size);
     ...
     */
    virtual ssize_t file_write(ebox::fs_file_t file, const void *buffer, size_t size);
     ...
     *  @return         0 on success, negative error code on failure
     */
    virtual int file_sync(ebox::fs_file_t file);
     ...
     */
    virtual off_t file_seek(ebox::fs_file_t file, off_t offset, int whence);
     ...
     */
    virtual off_t file_tell(ebox::fs_file_t file);
     ...
     */
    virtual off_t file_size(ebox::fs_file_t file);
     ...
     *  @return         0 on success, negative error code on failure
     */
    virtual int dir_open(ebox::fs_dir_t *dir, const char *path);
     ...
     *  return          0 on success, negative error code on failure
     */
    virtual int dir_close(ebox::fs_dir_t dir);
     ...
     */
    virtual ssize_t dir_read(ebox::fs_dir_t dir, struct dirent *ent);
     ...
     */
    virtual void dir_seek(ebox::fs_dir_t dir, off_t offset);
     ...
     */
    virtual off_t dir_tell(ebox::fs_dir_t dir);

    /** Rewind the current position to the beginning of the directory
     *
     *  @param dir      Dir handle
     */
    virtual void dir_rewind(ebox::fs_dir_t dir);
#endif //!(DOXYGEN_ONLY)

private:
    lfs_t _lfs; // The actual file system
    struct lfs_config _config;
    ebox::BlockDevice *_bd; // The block device
