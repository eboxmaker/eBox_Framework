...
#define LFS_INFO(fmt, ...)  ebox_printf("lfs info:%d: " fmt "\n", __LINE__, __VA_ARGS__)
...
#define LFS_DEBUG(fmt, ...) ebox_printf("lfs debug:%d: " fmt "\n", __LINE__, __VA_ARGS__)
...
#define LFS_WARN(fmt, ...)  ebox_printf("lfs warn:%d: " fmt "\n", __LINE__, __VA_ARGS__)
...
#define LFS_ERROR(fmt, ...) ebox_printf("lfs error:%d: " fmt "\n", __LINE__, __VA_ARGS__)
