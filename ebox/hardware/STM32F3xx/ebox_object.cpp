...
mcuGpio PH0(GPIOH, LL_GPIO_PIN_0);
mcuGpio PH1(GPIOH, LL_GPIO_PIN_1);
mcuGpio PH2(GPIOH, LL_GPIO_PIN_2);
mcuGpio PH3(GPIOH, LL_GPIO_PIN_3);
mcuGpio PH4(GPIOH, LL_GPIO_PIN_4);
mcuGpio PH5(GPIOH, LL_GPIO_PIN_5);
mcuGpio PH6(GPIOH, LL_GPIO_PIN_6);
mcuGpio PH7(GPIOH, LL_GPIO_PIN_7);
mcuGpio PH8(GPIOH, LL_GPIO_PIN_8);
mcuGpio PH9(GPIOH, LL_GPIO_PIN_9);
mcuGpio PH10(GPIOH, LL_GPIO_PIN_10);
mcuGpio PH11(GPIOH, LL_GPIO_PIN_11);
mcuGpio PH12(GPIOH, LL_GPIO_PIN_12);
mcuGpio PH13(GPIOH, LL_GPIO_PIN_13);
mcuGpio PH14(GPIOH, LL_GPIO_PIN_14);
mcuGpio PH15(GPIOH, LL_GPIO_PIN_15);

mcuGpio PI5(GPIOI, LL_GPIO_PIN_5);
mcuGpio PI6(GPIOI, LL_GPIO_PIN_6);
mcuGpio PI7(GPIOI, LL_GPIO_PIN_7);
#endif
