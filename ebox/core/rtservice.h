 ...
 */
inline int rt_list_isempty(const rt_list_t *l)
{
    return l->next == l;
}
 ...
 */
inline unsigned int rt_list_len(const rt_list_t *l)
{
    unsigned int len = 0;
    const rt_list_t *p = l;
    while (p->next != l)
 ...
 */
inline void rt_slist_init(rt_slist_t *l)
{
    l->next = NULL;
}

inline void rt_slist_append(rt_slist_t *l, rt_slist_t *n)
{
...
inline void rt_slist_insert(rt_slist_t *l, rt_slist_t *n)
{
    n->next = l->next;
    l->next = n;
}

inline unsigned int rt_slist_len(const rt_slist_t *l)
{
    unsigned int len = 0;
...
inline rt_slist_t *rt_slist_remove(rt_slist_t *l, rt_slist_t *n)
{
    /* remove slist head */
...
inline rt_slist_t *rt_slist_first(rt_slist_t *l)
{
    return l->next;
}

inline rt_slist_t *rt_slist_tail(rt_slist_t *l)
{
...
inline rt_slist_t *rt_slist_next(rt_slist_t *n)
{
    return n->next;
}

inline int rt_slist_isempty(rt_slist_t *l)
{
    return l->next == NULL;
}
