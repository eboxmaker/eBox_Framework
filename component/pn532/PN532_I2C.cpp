...
*/
/**************************************************************************/
PN532_I2C::PN532_I2C(Gpio *irq, Gpio *reset) {
  _irq = irq;
  _reset = reset;

    _irq->mode(INPUT_PU);
    _reset->mode(OUTPUT_PP_PU);
}
...
*/
/**************************************************************************/
void PN532_I2C::PrintHex(const byte * data, const uint32_t numBytes)
{
  uint32_t szPos;
...
*/
/**************************************************************************/
void PN532_I2C::PrintHexChar(const byte * data, const uint32_t numBytes)
{
  uint32_t szPos;
  for (szPos=0; szPos < numBytes; szPos++) 
  {
...
*/
/**************************************************************************/
uint8_t PN532_I2C::readGPIO(void) {
...
*/
/**************************************************************************/
boolean PN532_I2C::SAMConfig(void) {
...
*/
/**************************************************************************/
boolean PN532_I2C::setPassiveActivationRetries(uint8_t maxRetries) {
...
*/
/**************************************************************************/
boolean PN532_I2C::readPassiveTargetID(uint8_t cardbaudrate, uint8_t * uid, uint8_t * uidLength, uint16_t timeout) {
...
*/
/**************************************************************************/
bool PN532_I2C::mifareclassic_IsFirstBlock (uint32_t uiBlock)
{
...
*/
/**************************************************************************/
bool PN532_I2C::mifareclassic_IsTrailerBlock (uint32_t uiBlock)
{
  // Test if we are in the small or big sectors
  if (uiBlock < 128)
...
//  uint8_t len;
  ...
  if (pn532_packetbuffer[7] != 0x00)
  {
    ...
    PN532_I2C::PrintHexChar(pn532_packetbuffer, 12);
    #endif
    return 0;
  }  
...
*/
/**************************************************************************/
uint8_t PN532_I2C::mifareclassic_ReadDataBlock (uint8_t blockNumber, uint8_t * data)
{
  #ifdef MIFAREDEBUG
  ...
  if (pn532_packetbuffer[7] != 0x00)
  {
    ...
    PN532_I2C::PrintHexChar(pn532_packetbuffer, 26);
    #endif
    return 0;
  }
  ...
  /* Display data for debug if requested */
    ...
    PN532_I2C::PrintHexChar(data, 16);
  #endif
...
*/
/**************************************************************************/
uint8_t PN532_I2C::mifareclassic_WriteDataBlock (uint8_t blockNumber, uint8_t * data)
{
  #ifdef MIFAREDEBUG
...
*/
/**************************************************************************/
uint8_t PN532_I2C::mifareclassic_FormatNDEF (void)
{
...
*/
/**************************************************************************/
uint8_t PN532_I2C::mifareclassic_WriteNDEFURI (uint8_t sectorNumber, uint8_t uriIdentifier, const char * url)
{
...
*/
/**************************************************************************/
uint8_t PN532_I2C::mifareultralight_ReadPage (uint8_t page, uint8_t * buffer)
{
  if (page >= 64)
  {
    #ifdef MIFAREDEBUG
  ...
  /* Display data for debug if requested */
    ...
    PN532_I2C::PrintHexChar(buffer, 4);
  #endif
...
*/
/**************************************************************************/
boolean PN532_I2C::inDataExchange(uint8_t * send, uint8_t sendLength, uint8_t * response, uint8_t * responseLength) {
...
*/
/**************************************************************************/
boolean PN532_I2C::inListPassiveTarget() {
  pn532_packetbuffer[0] = PN532_COMMAND_INLISTPASSIVETARGET;
