...
OneButton::OneButton()
{
  ...
  // further initialization has moved to OneButton.h
    ...
    _clickFuncParam = NULL;

    _doubleClickFunc = NULL;
    _paramDoubleClickFunc = NULL;
    _doubleClickFuncParam = NULL;

    _multiClickFunc = NULL;
    _paramMultiClickFunc = NULL;
    _multiClickFuncParam = NULL;

    _longPressStartFunc = NULL;
    _paramLongPressStartFunc = NULL;
    _longPressStartFuncParam = NULL;
    ...
    _duringLongPressFuncParam = NULL;
    
    stateMachine_t _state = OCS_INIT;
    stateMachine_t _lastState = OCS_INIT; // used for debouncing
    _maxClicks = 1;       // max number (1, 2, multi=3) of clicks of interest by registration of event functions.
}
 ...
 */
OneButton::OneButton(Gpio* pin, const boolean activeState)
{
   OneButton();
  _pin = pin;
...
{
    _debounceTicks = 50; // number of ticks for debounce times.
    _clickTicks = 200;   // number of msecs before a click is detected.
    _pressTicks = 1500;   // number of msecs before a long button press is detected
